...
nf_hihestVol_PE = highest_Vol_PE(10,50,nf_nearest,url_nf)
...
print(strCyan(str("Support in Nifty:")) + str(nf_hihestVol_PE)+"\n"+"\n")
...
url="https://api.telegram.org/bot5771720913:AAH0A70f0BPtPjrOCTrhAb9LR7IGFBVt-oM/sendMessage?chat_id=-1001714168970&text='Hello World'"
requests.post(url)
exit()
